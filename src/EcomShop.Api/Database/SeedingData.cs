...
namespace EcomShop.Api.Database
{
    public class SeedingData
    {
        ...
        private static Product product1 = new Product("Smartphone X10", 499.99m, "The Smartphone X10 is packed with cutting-edge features, including a high-resolution camera and a powerful processor, making it perfect for staying connected and productive on the go.", category1.Id);
        private static Product product2 = new Product("Laptop ProBook 2022", 899.99m, "The Laptop ProBook 2022 offers superior performance and reliability, featuring a sleek design, long-lasting battery, and advanced security features for your peace of mind.", category1.Id);
        private static Product product3 = new Product("Running Shoes Elite", 129.99m, "Designed for serious runners, the Running Shoes Elite provide exceptional comfort, support, and durability, allowing you to achieve your personal best with every stride.", category2.Id);
        private static Product product4 = new Product("Hiking Boots Adventure", 149.99m, "Conquer any trail with confidence in the Hiking Boots Adventure. These rugged boots offer superior traction, waterproof protection, and unmatched durability for your outdoor adventures.", category2.Id);
        private static Product product5 = new Product("Smart Home Hub Plus", 199.99m, "Transform your home into a smart sanctuary with the Smart Home Hub Plus. Control your lights, appliances, and security cameras with ease, and enjoy the convenience of voice commands and automated routines.", category3.Id);
        private static Product product6 = new Product("Robot Vacuum Pro", 299.99m, "Say goodbye to manual vacuuming with the Robot Vacuum Pro. This intelligent robot cleaner navigates your home effortlessly, removing dirt, dust, and pet hair with precision, leaving your floors spotless.", category3.Id);
        private static Product product7 = new Product("Board Game Bonanza", 39.99m, "Gather your friends and family for hours of fun with the Board Game Bonanza. Featuring a variety of classic and modern games, this collection is sure to entertain players of all ages.", category4.Id);
        private static Product product8 = new Product("Outdoor Playset Deluxe", 499.99m, "Create unforgettable memories with the Outdoor Playset Deluxe. This premium playset includes a slide, swings, and a climbing wall, providing endless entertainment for kids in the backyard.", category4.Id);
